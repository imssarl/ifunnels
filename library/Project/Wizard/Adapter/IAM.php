...
class Project_Wizard_Adapter_IAM implements Project_Wizard_Adapter_Interface{
	...
	public function check(){
		...
		if( empty($_arrSettings['settings']['affiliate_id']) ){
...
//			}
	...
	private function prepare(){
		...
		$_model->getLinks( $_activeTemplates );
		@shuffle($_activeTemplates);
		$this->_templateId=@$_activeTemplates[0]['template_id'];
