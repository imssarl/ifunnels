...
class Project_Wizard_Domain_Rules_Zonterest extends Project_Wizard_Domain_Rules_Abstract implements Project_Wizard_Domain_Rules_Interface {

	protected $_arrX12=array(
		'x1'=>array('buy','find',''),
		'x2'=>array('top','popular','cheap',''),
		'x3'=>array('products','store','kindlestore')
	);
