...
class Project_Subscribers_Events extends Core_Data_Storage{
	...
	protected $_fields=array('id', 'sub_id', 'event_type', 'campaign_id', 'campaign_type', 'search_var', 'search_text', 'search_int', 'added');
	protected $_userId='';

	// event types
	const FROM_ADMIN=3, LEAD_FORM=1, EMIAL_FUNNEL=2, AUTOMATION=4;
	...
	public function install(){
		...
		try {
			...
			//========
			Core_Sql::setExec("CREATE TABLE `".$this->_table."` (
					`id` INT(11) NOT NULL AUTO_INCREMENT,
					`sub_id` INT(11) NULL DEFAULT NULL,
					`event_type` INT(3) NOT NULL DEFAULT '0',
					`added` INT(11) UNSIGNED NOT NULL DEFAULT '0',
					`campaign_id` INT(11) NULL DEFAULT NULL,
					`campaign_type` INT(1) NULL DEFAULT NULL,
					`search_var` VARCHAR(256) NULL DEFAULT NULL COLLATE 'utf8mb4_unicode_ci',
					`search_text` TEXT NULL COLLATE 'utf8mb4_unicode_ci',
					`search_int` INT(11) NULL DEFAULT NULL,
					UNIQUE INDEX `id` (`id`)
				);");
			//========
