...
module.exports = (env) =>
  smp.wrap({
    entry: {
      ...
      leadchannels: "./assets/js/leadchannels.js",
      sticky: "./assets/js/sticky.js",
      flipobj: "./assets/js/flip.js",
      emailto: "./assets/js/emailto.js",
      triggered: "./assets/js/triggered.js",
      ...
      statistic: "./assets/js/statistic.js",
      quizobj: "./assets/js/quiz.js",
      lazyload: "./assets/js/lazyload.js",
      link: "./assets/js/link.js",
      effects: "./assets/js/effects.js",
      testab: "./assets/js/test-ab.js",
	  "video-ui": "./assets/js/video-ui.js"
    },
    output: {
      path: __dirname + "/build/",
      publicPath: "/skin/pagebuilder/build/",
