...
(function() {
	...
	scriptTag.id = "fr-fek";
	scriptTag.text = 'try{(function (k){localStorage.FEK=k;t=document.getElementById(\'fr-fek\');t.parentNode.removeChild(t);})(\'KB2A3C2D3rD1H5D4H3B2B10C8E2D5C3eUh1QBRVCDLPAZMBQ==\')}catch(e){};';
