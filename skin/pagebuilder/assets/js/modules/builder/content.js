(function () {
    ...
    var styleeditor = require('./styleeditor.js').styleeditor;
        ...
        init: function() {
            ...
            publisher.subscribe('onBeforeSave', function () {
                ...
                if ( Object.keys(contenteditor.activeEditor).length !== 0 ) {
                    ...
                    contenteditor.activeEditor.element.removeAttribute('data-sbpro-editor');
        ...
        */
        contentClick: function (element) {
            ...
            $(element.element).addClass('sb_open').froalaEditor(froalaConfig).on('froalaEditor.blur', function (e, editor) {
                ...
                if ( contenteditor.hasChanges ) {
                    publisher.publish('onBlockChange', element.parentBlock, 'change');
                    element.element.querySelectorAll('a').forEach(a => styleeditor.setupCanvasElementsOnElement(a, 'a'));
                } 
