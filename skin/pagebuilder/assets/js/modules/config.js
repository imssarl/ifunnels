...
(function () {
    ...
    module.exports.google_api_url = (cConfig.google_api_url) ? cConfig.google_api_url : "https://fonts.googleapis.com/css?display=swap&family=";

    module.exports.pageContainer = (cConfig.pageContainer) ? cConfig.pageContainer : "#page";

    module.exports.bodyPaddingClass = (cConfig.bodyPaddingClass) ? cConfig.bodyPaddingClass : "bPadding";

    module.exports.editableItems = (cConfig.editableItems) ? cConfig.editableItems : {
        'span.fa, i.fa': ['color', 'font-size'],
        '.bg.bg1': ['background-color'],
        'nav a': [ 'text', 'color', 'font-weight', 'text-transform', 'background-color'],
        'img': ['border-top-left-radius', 'border-top-right-radius', 'border-bottom-left-radius', 'border-bottom-right-radius', 'border-color', 'border-style', 'border-width', 'inline-position'],
        ...
        'a.btn, button.btn': [ 'text', 'color', 'font-family', 'font-size', 'btn-style', 'btn-size', 'btn-block', 'inline-position', 'background-color', 'margin-top', 'margin-bottom', 'border-style', 'border-width', 'border-color', 'border-radius'],

        '*[data-container="button"] > .btn': ['margin-top', 'margin-bottom', 'margin-left', 'margin-right'],
        '*[data-container="divider"] > hr': ['margin-top', 'margin-bottom', 'margin-left', 'margin-right', 'divider-style'],
        '*[data-container="form"] > form': ['margin-top', 'margin-bottom', 'margin-left', 'margin-right'],
        '*[data-component="heading"] > *': ['font-size', 'font-weight', 'text-transform', 'color', 'margin-top', 'margin-bottom', 'margin-left', 'margin-right', 'text-align', 'background-color'],
        ...
        '*[data-component="text"] > *': ['font-size', 'font-weight', 'text-transform', 'color', 'margin-top', 'margin-bottom', 'margin-left', 'margin-right', 'text-align',  'background-color'],
        '*[data-component="video"] > .videoWrapper': ['margin-top', 'margin-bottom', 'margin-left', 'margin-right', 'stick'],
        ...
        '*[data-component="grid"]': ['custom', 'margin-top', 'margin-bottom'],
        '*[data-component="grid"] > div': ['margin-top', 'margin-bottom', 'margin-left', 'margin-right', 'padding-top', 'padding-bottom', 'padding-left', 'padding-right', 'background-color', 'background-color-overlay', 'background-image', 'text-align', 'stick'],
        '*[data-component="code"] > .codeblock' : ['margin-top', 'margin-bottom', 'margin-left', 'margin-right'],
		
		'*[data-component="countdown"]' : ['countdown-type', 'countdown-value', 'countdown-action', 'countdown-redirect', 'countdown-style', 'countdown-labels', 'countdown-delay','countdown-direction','countdown-textcolor','countdown-panelcolor','countdown-labelcolor', 'margin-top', 'margin-bottom', 'margin-left', 'margin-right', 'padding-top', 'padding-bottom', 'padding-left', 'padding-right', 'background-color'],
	//	'*[data-component="countdown"] .tick-flip-panel' : ['background-color'],
		
		'*[data-component="quest-box"]' : [ 'blockid', 'width', 'height', 'margin', 'padding', 'background-color', 'border-radius', 'border-style', 'border-width', 'border-color'],
		'*[data-component="quest-bar"]' : ['margin', 'padding', 'background-color', 'progress-color' /*, 'border-style', 'border-width', 'border-color',*/ ],
		'*[data-component="quest"]' : ['margin', 'padding', 'background-color', 'border-radius', 'border-style', 'border-width', 'border-color', 'hover-background-color' ],
        
        '*[data-component="divider"]' : [ 'divider-style', 'divider-color' ],
		
        'form': ['margin-top', 'margin-bottom'],
        'nav': ['navbar-style', 'navbar-alignment', 'margin-top', 'margin-bottom'],
        '.sbpro-bg-styler': ['sbpro-bg-styler-padding', 'sbpro-border-radius', 'sbpro-bg', 'sbpro-border', 'background-image', 'background-color', 'stick'],

        'ul[class*="social-"]': ['social-list-size', 'list-align'],

        '*[data-component="map"] .mapOverlay': ['height', 'margin-top', 'margin-bottom'],

        '.block': ['background-color', 'background-color-overlay', 'background-image', 'padding-top', 'padding-bottom', 'background-position', 'parallax', 'stick'],

        '.navbar-brand img': ['margin-left', 'margin-right', 'height'],

        '.sbpro-block-background, .background-cover': ['background-color', 'background-image', 'padding-top', 'padding-bottom', 'background-position'],
        '.sbpro-content-background': ['background-color'],
        'input, textarea' : ['margin', 'padding', 'height', 'background-image', 'background-color', 'border-radius', 'border-style', 'border-width', 'border-color', 'font-size'],
        'label' : ['margin-top', 'margin-right', 'margin-bottom', 'margin-left', 'color', 'display'],
        'a' : [ 'color' ],
        '*[data-component="chat"]': ['margin-top', 'margin-right', 'margin-bottom', 'margin-left', 'height'],
        '*[data-component="nft"]': ['margin-top', 'margin-right', 'margin-bottom', 'margin-left', 'text-align'],
    };

    module.exports.inputAppend = (cConfig.inputAppend) ? cConfig.inputAppend : ['custom', 'border-radius', 'font-size', 'margin-top', 'margin-bottom', 'margin-left', 'margin-right', 'padding-top', 'padding-bottom', 'padding-left', 'padding-right', 'height', 'width', 'countdown-value', 'countdown-delay','countdown-textcolor','countdown-panelcolor','countdown-labelcolor','countdown-redirect', 'progress-color', 'progress-color', 'quiz-progress', 'blockid', 'quiz-blockid' ];

    module.exports.editableItemOptions = (cConfig.editableItemOptions) ? cConfig.editableItemOptions : {
        'nav a : font-weight': ['100', '200', '300', '400', '500', '600', '700', '800', '900'],
//        'a.btn, button.btn : border-radius': ['0px', '4px', '10px'],
        'input, textarea : border-style': ['none', 'dotted', 'dashed', 'solid'],
		'input, textarea : border-width': ['1px', '2px', '3px', '4px'],
        'a.btn, button.btn : border-style': ['none', 'dotted', 'dashed', 'solid'],
		'a.btn, button.btn : border-width': ['1px', '2px', '3px', '4px'],
		
        '*[data-component="quest-box"] : border-style': ['none', 'dotted', 'dashed', 'solid'],
		'*[data-component="quest-box"] : border-width': ['1px', '2px', '3px', '4px'],
        '*[data-component="quest-bar"] : border-style': ['none', 'dotted', 'dashed', 'solid'],
		'*[data-component="quest-bar"] : border-width': ['1px', '2px', '3px', '4px'],
        '*[data-component="quest"] : border-style': ['none', 'dotted', 'dashed', 'solid'],
        '*[data-component="quest"] : border-width': ['1px', '2px', '3px', '4px'],
        
        '*[data-component="heading"] > * : font-weight': ['100', '200', '300', '400', '500', '600', '700', '800', '900'],
        '*[data-component="text"] > * : font-weight': ['100', '200', '300', '400', '500', '600', '700', '800', '900'],
        '*[data-component="heading"] > * : text-transform': ['capitalize', 'lowercase', 'uppercase', 'none'],
        '*[data-component="text"] > * : text-transform': ['capitalize', 'lowercase', 'uppercase', 'none'],
    ...
    module.exports.customStyleDropdowns = (cConfig.customStyleDropdowns) ? cConfig.customStyleDropdowns : {
        'stick': {
        ...
        'countdown-style': {
            'label': 'Preset',
            'values': {
                'Month day hour min sec': 'months',
                'Day hour min sec': 'days',
                'Day hour min': 'days2',
                'Hour min sec': 'hours',
                'Min sec': 'minuts',
            },
        ...
        'countdown-type': {
            ...
            'values': {
                ...
                'Bilboard': 'bilboard',
                'Timer': 'timer',
                'Timed countdown': 'timercountdown',
                'Clock': 'clock',
            },
            'default': 'timer'
        },
        ...
        'font-family': {
            'label': 'Font Family',
            'values': {
                'Abril Fatface': 'font-AbrilFatface',
                'Alegreya Sans' : 'font-AlegreyaSans',
                'Anton' : 'font-Anton',
                'Bree Serif' : 'font-BreeSerif',
                'Nanum Brush Script' : 'font-NanumBrushScript',
                'Patua One' : 'font-PatuaOne',
                'Architects Daughter' : 'font-ArchitectsDaughter',
                'Give You Glory' : 'font-GiveYouGlory',
                'Gochi Hand' : 'font-GochiHand',
                'Kaushan Script' : 'font-KaushanScript',
                'La Belle Aurore' : 'font-LaBelleAurore',
                'Loved by the King' : 'font-LovedbytheKing',
                'Marck Script' : 'font-MarckScript',
                'Over the Rainbow' : 'font-OvertheRainbow', 
                'Walter Turncoat' : 'font-WalterTurncoat',
                ...
                'Magra' : 'font-Magra',
                'Oxygen' : 'font-Oxygen',
                'Permanent Marker' : 'font-PermanentMarker',
                'Rambla' : 'font-Rambla',
                'Signika Negative' : 'font-SignikaNegative',
                'Titillium Web' : 'font-TitilliumWeb'
            },
            'default': 'font-AbrilFatface'
        },
        'divider-style' : {
            'label' : 'Divider Style',
            'values' : {
    ...
    module.exports.responsiveModes = (cConfig.responsiveModes) ? cConfig.responsiveModes : {
        desktop: '100%',
        mobile: '480px',
        tablet: '1024px'
    };

    module.exports.autoSaveTimeout = (cConfig.autoSaveTimeout) ? cConfig.autoSaveTimeout :  300000;

    module.exports.sourceCodeEditSyntaxDelay = (cConfig.sourceCodeEditSyntaxDelay) ? cConfig.sourceCodeEditSyntaxDelay : 10000;

    module.exports.cssUrls = [
        '/skin/pagebuilder/elements/css/blocks.css',
        '/skin/pagebuilder/elements/css/media.css'
    ];

    module.exports.externalJS = (cConfig.externalJS) ? cConfig.externalJS : [
        '/skin/pagebuilder/build/inblock.bundle.js',
        '/skin/pagebuilder/build/sticky.bundle.js'
    ];

    module.exports.aceTheme = (cConfig.externalJS) ? cConfig.externalJS : "twilight"; //Theme for the Ace editor, more info here: https://github.com/ajaxorg/ace/tree/master/lib/ace/theme

    module.exports.navSelector = (cConfig.navSelector) ? cConfig.navSelector : "nav";
    module.exports.navActiveClass = (cConfig.navActiveClass) ? cConfig.navActiveClass : "active";

    module.exports.sentApiURL = (cConfig.sentApiURL) ? cConfig.sentApiURL : 'services/ifunnels.php';

    module.exports.imageLightboxWrapper = (cConfig.imageLightboxWrapper) ? cConfig.imageLightboxWrapper : ".overlay-wrapper";
    module.exports.imageLightboxAttr = (cConfig.imageLightboxAttr) ? cConfig.imageLightboxAttr : "data-gallery";

    module.exports.sideMenuArrowSVG = (cConfig.sideMenuArrowSVG) ? cConfig.sideMenuArrowSVG : '<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 16 16" xml:space="preserve" width="16" height="16"><g class="nc-icon-wrapper" fill="#bdc3c7"><polygon fill="#bdc3c7" points="4.9,15.7 3.4,14.3 9.7,8 3.4,1.7 4.9,0.3 12.6,8 "></polygon></g></svg>';

    module.exports.froalaConfig = (cConfig.froalaConfig) ? cConfig.froalaConfig : {
        toolbarInline: true,
        charCounterCount: false,
        toolbarButtons: ['bold', 'italic', 'underline', 'strikeThrough', '|', 'fontFamily', 'fontSize', 'color', '|', 'paragraphFormat', 'align', '|', 'insertLink', '|', 'clearFormatting', '|', 'undo', 'redo'],
    ...
    module.exports.runInBlocks = (cConfig.runInBlocks) ? cConfig.runInBlocks : function () {
		window.onload = function(){
			...
			$('*[data-parallax]').each(function () {
				...
				this.style.backgroundImage = "url('" + this.getAttribute('data-image-src') + "')";

			});
		};
    };

    module.exports.rebuildSlideshowNavigation = (cConfig.rebuildSlideshowNavigation) ? cConfig.rebuildSlideshowNavigation : function (slideshow) {
    ...
    module.exports.inBlockBeforeSave = (cConfig.inBlockBeforeSave) ? cConfig.inBlockBeforeSave : function (frameDocument) {
    ...
    module.exports.shapeDividers = {
        ...
        'curve-opacity' : {
            ...
            'path' : [
                {
                    'fill' : '#464D54',
                    'd' : 'M0,13.229V23.87h240V13.27C212.247,6.884,170.508,0,119.81,0C69.18,0,27.642,6.884,0,13.229z',
                    'fill-opacity': "0.33"
                },
                {
                    'fill' : '#464D54',
                    'd' : 'M0,18.904V24h240v-5.036c-21.641-6.315-64.639-16.257-120.171-16.257C64.351,2.707,21.572,12.589,0,18.904z',
                    'fill-opacity' : "0.33"
                },
                {
                    'fill' : '#464D54',
        ...
        'curve-asym' : {
            ...
            'path' : [
                {
                    'fill' : '#464D54',
                    'd' : 'M0,24C47.998-8.383,93.12-7.614,240,24H0z'
                }
            ]
        },
        'curve-asym-opacity' : {
            ...
            'path' : [
                {
                    'fill' : '#464D54',
                    'fill-opacity' : "0.33",
                    'd' : 'M0,7.172V24h240v-4.516C97.769-1.212,33.652-5.596,0,7.172z'
                },
                {
                    'fill' : '#464D54',
                    'fill-opacity' : "0.33",
                    'd' : 'M0,14.252V24h240v-2.828C95.62-3.818,34.971-6.586,0,14.252z'
                },
                {
                    'fill' : '#464D54',
                    'd' : 'M0,24C47.91-5.717,92.93-5,239.521,24H0z'
                }
            ]
        },
        'book' : {
            ...
            'path' : [
                {
                    'fill' : '#464D54',
                    'd' : 'M0,24C96.789,22.854,120,3.417,120,0c0,3.417,23.203,22.854,120,24H0z'
                }
            ]
        },
        'spear' : {
            ...
            'path' : [
                {
                    'fill' : '#464D54',
                    'd' : 'M134.698,24C124.5,24,120,13.04,120,0c0,13.04-4.5,24-14.698,24H134.698z'
                }
            ]
        },
        'arrow' : {
            ...
            'path' : [
                {
                    'fill' : '#464D54',
                    'd' : 'M132,24L119.988,0L108,23.97V24H132z'
                }
            ]
        },
        'mountains' : {
        ...
        'triangle' : {
            ...
            'path' : [
                {
                    'fill' : '#464D54',
                    'd' : 'M240,24L119.878,0L0,23.96V24H240z'
                }
            ]
        },
        'pyramids' : {
            ...
            'path' : [
                {
                    'fill' : '#464D54',
                    'd' : 'M240,24L159.961,0l-74.36,21.1l-28.56-7.31L0,24H240z'
                }
            ]
        },
        'tilt' : {
        ...
        'tilt-opacity' : {
            ...
            'path' : [
                ...
                {
                    'fill' : '#464D54',
                    'd' : 'M240,24V3.72L0,24H240z'
                },
                {
                    'fill' : '#464D54',
                    'fill-opacity' : "0.33",
                    'd' : 'M240,24V1.99L0,24H240z'
                }
            ]
        },
        'ray-opacity' : {
            ...
            'path' : [
                ...
                },
                {
                    'fill' : '#464D54',
                    'fill-opacity' : "0.33",
                    'd' : "M0,11.611V24L240,0L0,11.611z"
                }
            ]
        },
        'fan-opacity' : {
            ...
            'path' : [
                {
                    'fill' : '#464D54',
                    'fill-opacity' : "0.25",
                    'd' : 'M0,24h240V0L0,11.26V24z'
                },
                {
                    'fill' : '#464D54',
                    'd' : 'M240,24H0V11.26L240,24z'
                },
                {
                    'fill' : '#464D54',
                    'fill-opacity' : "0.5",
                    'd' : 'M240,24H0V11.26h240V24z'
                }
            ]
        },
        'swoosh' : {
            ...
            'path' : [
                {
                    'fill' : '#464D54',
                    'd' : 'M239.766,24L240,0c-51.797,0-69.883,14.65-94.707,17.68c-24.691,2.98-43.872-4.1-63.765-4c-19.17,0.101-31.196,4.562-51.309,8.2C15.552,24.529,4.321,23.59,0,23.04V24H239.766z'
                }
            ]
        },
        'swoosh-opacity' : {
            ...
            'path' : [
                ...
                },
                {
                    'fill' : '#464D54',
                    'fill-opacity' : "0.33",
                    'd' : 'M240,24V2.21c-51.797,0-69.883,11.96-94.707,14.16c-24.691,2.149-43.872-1.08-63.765-1.021c-19.17,0.069-31.196,3.311-51.309,5.971C15.552,23.23,4.321,22.58,0,22.189V24h239.766H240z'
                },
                {
                    'fill' : '#464D54',
                    'd' : 'M240,24V3.72c-51.797,0-69.883,11.64-94.707,14.021c-24.691,2.359-43.872-3.25-63.765-3.17c-19.17,0.109-31.196,3.6-51.309,6.529C15.552,23.209,4.321,22.47,0,22.029V24H240z'
                }
            ]
        },
        'waves' : {
            ...
            'path' : [
                {
                    'fill' : '#464D54',
                    'd' : 'M240,0.393c-4.844-0.838-10.605-0.279-17.471,1.149c-20.303,4.149-24.6,14.056-38.877,19.621C159.648,30.525,142.076,0.523,120,0.523c-23.516,0-35.499,29.375-61.632,21.333C39.721,16.104,32.948,6.39,15.888,9.458C9.751,10.566,4.438,12.747,0,15.773V24h240V0.393z'
                }
            ]
        },
        'waves-opacity' : {
            ...
            'path' : [
                {
                    'fill' : '#464D54',
                    'fill-opacity' : "0.33",
                    'd' : 'M239.971,0.038c-4.61-0.19-9.552,0.34-15,1.32c-20.395,3.721-26.233,12.311-39.419,17.292c-22.208,8.379-41.546-14.521-65.619-14.521c-25.681,0-30.486,25.262-62.506,18.051C34.632,16.999,27.625,8.329,10.323,11.059c-2.71,0.44-6.553,1.04-10.323,1.81V24h240V0.038H239.971z'
                },
                {
                    'fill' : '#464D54',
                    'fill-opacity' : "0.33",
                    'd' : 'M222.049,3.889c-20.803,3.72-25.198,12.582-39.849,17.582c-24.611,8.399-40.728-18.493-63.342-18.493c-24.124,0-38.287,26.312-65.082,19.102C34.707,16.919,27.743,8.239,10.27,10.979c-3.717,0.59-7.149,1.52-10.27,2.72V24h240V2.888C234.979,2.148,229.1,2.638,222.049,3.889z'
                },
                {
                    'fill' : '#464D54',
                    'd' : 'M239.99,5.699c-4.825-0.64-10.606-0.21-17.48,0.89C202.234,9.81,197.917,17.48,183.618,21.8c-23.967,7.28-39.71-16.011-61.787-16.011c-23.521,0-37.345,22.751-63.486,16.542C39.701,17.88,32.922,10.35,15.861,12.73C9.751,13.58,4.438,15.29,0,19.423V24h240V7.152L239.99,5.699z'
                }
            ]
        },
        'hills' : {
        ...
        'flow' : {
            ...
            'path' : [
                {
                    'fill' : '#464D54',
                    'd' : 'M240,5.513c-10.195-6.548-32.402-6.238-52.285,0.07c-15.596,4.889-25.732,12.188-37.217,11.099c-11.045-1.039-8.398-8.449-18.789-8.499c-14.258-0.09-25.801,13.897-40.078,15.277C75.352,25.039,81.899,7.692,64.81,1.864C49.629-3.305,21.479,2.554,0,16.011V24h240V5.513L240,5.513z'
                }
            ]
        },
        'flow-opacity' : {
            ...
            'path' : [
                {
                    'fill' : '#464D54',
                    'fill-opacity' : "0.33",
                    'd' : 'M0,24h240V0.359c-11.387-1.23-27.227,0.77-44.746,4.87c-19.092,4.46-23.965,12.33-36.084,11.378c-11.553-0.906-10.596-7.438-21.67-7.468c-15-0.02-25.952,11.817-40.542,12.917c-16.318,1.219-10-13.167-25.938-17.999C57.48-0.068,21.582,4.509,0,14.631V24L0,24z'
                },
                {
                    'fill' : '#464D54',
                    'fill-opacity' : "0.33",
                    'd' : 'M191.934,6.021c-18.008,4.371-22.969,12.083-34.883,11.141c-11.328-0.898-9.746-7.29-20.488-7.29C121.993,9.852,108.243,21.421,94.17,22.5C78.481,23.701,85.991,9.669,69.912,4.912C55.752,0.723,19.248,5.69,0,16.393V24h240V4.371C228.818,0.96,211.68,1.25,191.934,6.021z'
                },
                {
                    'fill' : '#464D54',
                    'd' : 'M240,9.141c-10.195-5.24-32.402-5.01-52.285,0.05c-15.615,3.95-25.732,9.818-37.236,8.959c-11.045-0.852-8.397-6.77-18.789-6.839c-14.257-0.051-25.8,11.162-40.078,12.261C75.342,24.87,81.89,10.899,64.8,6.223C49.629,2.042,21.479,6.771,0,17.602V24h240V9.141L240,9.141z'
                }
            ]
        },
        'step' : {
        ...
        'curve-inv' : {
            ...
            'path' : [
                {
                    'fill' : '#464D54',
                    'd' : 'M0,24l0.01-0.24V0H240v24c0,0-48.115-23.471-120.039-23.48C48.018,0.52,0,24,0,24L0,24z'
                }
            ]
        },
        'curve-opacity-inv' : {
            ...
            'path' : [
                ...
                {
                    'fill' : '#464D54',
                    'd' : 'M119.829,2.661c55.562,0,98.521,9.957,120.171,16.271V0H0v18.902C21.582,12.598,64.37,2.65,119.829,2.661z',
                    'fill-opacity' : "0.33"
                },
                {
                    'fill' : '#464D54',
        ...
        'curve-asym-inv' : {
            ...
            'path' : [
                {
                    'fill' : '#464D54',
                    'd' : 'M0,0v24C47.998-8.379,93.12-7.608,240,24l0,0V0H0z'
                }
            ]
        },
        'curve-asym-opacity-inv' : {
            'x' : "0px",
            'y' : "0px",
            'width' : "240px",
            'height' : "24px",
            ...
            'path' : [
                {
                    'fill' : '#464D54',
                    'fill-opacity' : "0.33",
                    'd' : 'M0,0v24C47.91-5.42,92.93-4.712,239.512,24H240V0.02L0,0z'
                },
                {
                    'fill' : '#464D54',
                    'fill-opacity' : "0.33",
                    'd' : 'M0,0.02v14.361C34.971-6.26,95.62-3.501,240,21.203V0.02H0L0,0.02z'
                },
                {
                    'fill' : '#464D54',
                    'd' : 'M0,0.02v7.359C33.652-5.278,97.769-0.918,240,19.553V0.02H0L0,0.02z'
                }
            ]
        },
        'book-inv' : {
            ...
            'path' : [
                {
                    'fill' : '#464D54',
                    'd' : 'M0,0v24c0,0,19.131-0.15,46.562-0.068C91.348,24.093,119.761,4.839,120,0.239c0.239,4.6,28.633,23.854,73.438,23.692C220.879,23.857,240,24,240,24V0H0z'
                }
            ]
        },
        'spear-inv' : {
            ...
            'path' : [
                {
                    'fill' : '#464D54',
                    'd' : 'M240,0v24H134.698C124.5,24,120,13.04,120,0H240z M0,24h105.302C115.5,24,120,13.04,120,0H0V24z'
                }
            ]
        },
        'arrow-inv' : {
            ...
            'path' : [
                {
                    'fill' : '#464D54',
                    'd' : 'M240,24V0H119.98l22.812,24H240z M97.202,24v-0.029L119.971,0H0v24H97.202z'
                }
            ]
        },
        'mountains-inv' : {
        ...
        'triangle-inv' : {
            ...
            'path' : [
                {
                    'fill' : '#464D54',
                    'd' : 'M119.888,0.24L240,24V0H0v23.971L119.888,0.24z'
                }
            ]
        },
        'pyramids-inv' : {
            ...
            'path' : [
                {
                    'fill' : '#464D54',
                    'd' : 'M159.961,0L240,23.99V0H159.961z M0,24l57.051-10.216l28.56,7.315L159.961,0H0V24z'
                }
            ]
        },
        'tilt-inv' : {
        ...
        'tilt-opacity-inv' : {
            ...
            'path' : [
                ...
                {
                    'fill' : '#464D54',
                    'd' : 'M0,0v20.279L240,0H0z'
                },
                {
                    'fill' : '#464D54',
                    'fill-opacity' : "0.33",
                    'd' : 'M0,0v22.01L240,0H0z'
                }
            ]
        },
        'ray-opacity-inv' : {
            ...
            'path' : [
                ...
                },
                {
                    'fill' : '#464D54',
                    'fill-opacity' : "0.33",
                    'd' : "M240,12.393V0L0,24L240,12.393z"
                }
            ]
        },
        'fan-opacity-inv' : {
            ...
            'path' : [
                {
                    'fill' : '#464D54',
                    'fill-opacity' : "0.25",
                    'd' : 'M240,0H0v24l240-11.26V0z'
                },
                {
                    'fill' : '#464D54',
                    'd' : 'M0,0h240v12.74L0,0z'
                },
                {
                    'fill' : '#464D54',
                    'fill-opacity' : "0.5",
                    'd' : 'M0,0h240v12.74H0V0z'
                }
            ]
        },
        'swoosh-inv' : {
            ...
            'path' : [
                {
                    'fill' : '#464D54',
                    'd' : 'M0,23.368c4.321,0.576,15.532,1.5,30.21-1.188c20.112-3.711,32.138-8.234,51.309-8.315c19.902-0.103,39.072,7.08,63.754,4.057C170.117,14.889,188.203,0,240,0H0V23.368z'
                }
            ]
        },
        'swoosh-opacity-inv' : {
            ...
            'path' : [
                {
                    'fill' : '#464D54',
                    'fill-opacity' : "0.33",
                    'd' : 'M240,0H0v23.539c4.321,0.414,15.532,1.113,30.21-0.912c20.112-2.798,32.139-6.213,51.309-6.309c19.902-0.073,39.072,3.361,63.754,1.07c24.806-2.301,42.91-15.015,94.707-15.015'
                },
                {
                    'fill' : '#464D54',
                    'fill-opacity' : "0.33",
                    'd' : 'M240,0H0v23.359c4.321,0.468,15.532,1.25,30.21-0.987c20.112-3.085,32.139-6.827,51.309-6.923c19.902-0.074,39.072,5.874,63.754,3.361c24.806-2.524,42.91-14.867,94.707-14.867'
                },
                {
                    'fill' : '#464D54',
                    'd' : 'M0,23.338c4.321,0.455,15.532,1.241,30.21-0.996c20.112-3.105,32.139-6.871,51.309-6.977c19.902-0.098,39.072,3.699,63.754,1.145C170.117,13.975,188.203,0,240,0H0V23.338z'
                }
            ]
        },
        'waves-inv' : {
            ...
            'path' : [
                {
                    'fill' : '#464D54',
                    'd' : 'M0,0v16.426c4.438-3.019,9.751-5.239,15.889-6.328c17.07-3.109,23.833,6.718,42.48,12.496C84.502,30.713,96.484,1.02,120,1.02c22.075,0,39.648,30.363,63.652,20.895c14.277-5.64,18.574-15.616,38.877-19.845c6.865-1.43,12.628-1.99,17.472-1.15V0H0L0,0z'
                }
            ]
        },
        'waves-opacity-inv' : {
            ...
            'path' : [
                {
                    'fill' : '#464D54',
                    'fill-opacity' : "0.33",
                    'd' : 'M0,0v14.182c3.124-1.22,6.56-2.13,10.27-2.708c17.499-2.73,24.44,5.98,43.547,11.129C80.628,29.842,93.06,3.44,117.158,3.44c22.631,0,40.458,26.955,65.074,18.553c14.645-5.021,19.015-13.912,39.855-17.623c7.049-1.25,12.926-1.79,17.912-1.02V0'
                },
                {
                    'fill' : '#464D54',
                    'fill-opacity' : "0.33",
                    'd' : 'M0,0v13.372c3.764-0.791,7.63-1.391,10.323-1.801c17.298-2.74,24.341,5.98,47.129,11.132C89.473,29.934,92.539,4.58,118.224,4.58c24.092,0,45.193,22.971,67.344,14.572c13.188-5.021,19.053-13.632,39.426-17.354C230.469,0.81,235.387,0.3,240,0.48V0'
                },
                {
                    'fill' : '#464D54',
                    'd' : 'M0,0v18.102c4.434-2.317,9.751-4,15.885-4.869c17.067-2.378,23.832,5.16,42.482,9.621C84.5,29.109,96.594,6.26,120.117,6.26c22.078,0,39.531,23.332,63.539,16.063c14.271-4.341,18.572-12.032,38.865-15.242C229.402,5.98,235.171,5.55,240,6.19V0'
                }
            ]
        },
        'hills-inv' : {
        ...
        'flow-inv' : {
            ...
            'path' : [
                {
                    'fill' : '#464D54',
                    'd' : 'M64.819,1.902c17.09,5.936,10.542,23.624,26.831,21.993c14.277-1.422,25.83-15.676,40.079-15.576c10.391,0.08,7.754,7.626,18.789,8.649c11.465,1.101,21.621-6.337,37.178-11.312c19.893-6.417,42.109-6.737,52.305-0.06V0H0v16.327C21.479,2.603,49.629-3.363,64.819,1.902z'
                }
            ]
        },
        'flow-opacity-inv' : {
            ...
            'path' : [
                {
                    'fill' : '#464D54',
                    'fill-opacity' : "0.33",
                    'd' : 'M0,0v14.873C21.602,4.718,57.48,0.13,71.021,4.278C86.958,9.136,80.64,23.589,96.958,22.37C111.548,21.26,122.5,9.375,137.5,9.415c11.055,0.02,10.098,6.587,21.68,7.487c12.129,0.959,16.992-6.938,36.074-11.436C212.773,1.339,228.613-0.62,240,0.569V0H0z'
                },
                {
                    'fill' : '#464D54',
                    'fill-opacity' : "0.33",
                    'd' : 'M0,16.672C19.248,5.947,55.752,0.959,69.912,5.138C85.991,9.896,78.481,23.98,94.17,22.789c14.072-1.039,27.822-12.684,42.393-12.653c10.742,0.021,9.16,6.438,20.488,7.316c11.914,0.948,16.875-6.767,34.883-11.155C211.67,1.509,228.799,1.209,240,4.638V0H0'
                },
                {
                    'fill' : '#464D54',
                    'd' : 'M0,0v17.922C21.479,7.057,49.629,2.329,64.819,6.497c17.09,4.708,10.542,18.69,26.831,17.422c14.277-1.119,25.83-12.344,40.079-12.304c10.391,0.05,7.754,6.037,18.789,6.876c11.465,0.858,21.621-5.017,37.178-8.966c19.893-5.097,42.109-5.347,52.305-0.06V0H0z'
                }
            ]
        },
        'step_1_2-inv' : {
    ...
    module.exports.countdownProps = [ 'countdown-type', 'countdown-action', 'countdown-style', 'countdown-labels', 'countdown-direction'];
