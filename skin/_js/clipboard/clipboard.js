var Clipboard=new Class({
	initialize: function( elements ){
		...
		this.init.delay(1200,this);
	},
	init: function(){
		if(typeof this.elements != 'object'){return; }
		ZeroClipboard.setMoviePath('/skin/_js/clipboard/clipboard.swf');
		this.elements.each(function( el ){
			var content=this.getElement( el );
			var clip = new ZeroClipboard.Client();
			clip.addEventListener('mousedown',function() {
			  clip.setText(content.value);
			});
	...
	getElement: function(el){
		...
		return $$('.clipboard-text.clipboard-id-'+el_id)[0];
	}
});
