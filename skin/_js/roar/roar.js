...
var Roar = new Class({
    ...
    alert: function(title, message, options) {
        var params = Array.link(arguments, {title: Type.isString, message: Type.isString, image: Type.isString, options: Type.isObject});
		var items = [];
		if (params.image) items.push(new Element('div', {'class': params.image}));
		items.push(new Element('h3', {'html': params.title}));
