...
var changeptype = function(){
    ...
    if(!jQuery("#wrapper").hasClass("forced")){
      if(w > 990){
        jQuery("body").removeClass("smallscreen").addClass("widescreen");
          jQuery("#wrapper").removeClass("enlarged");
      }else{
        jQuery("body").removeClass("widescreen").addClass("smallscreen");
        jQuery("#wrapper").addClass("enlarged");
...
function toggle_slimscroll(item){
    if(jQuery("#wrapper").hasClass("enlarged")){
      jQuery(item).css("overflow","inherit").parent().css("overflow","inherit");
      jQuery(item). siblings(".slimScrollBar").css("visibility","hidden");
    }else{
