...
{if empty($arrPrm.item_id)}
	<textarea cols="10" rows="6" name="{$arrPrm.textarea_name}" class="wh-tag-textarea form-control"></textarea>
{else}
	...
	<div class="wh-tag-actions"><input type="button" class="wh-tag-edit button" value="Edit" /><input type="button" class="wh-tag-save button" value="Save" /><input type="button" class="wh-tag-cancel button" value="Cancel"> </div>
{/if}
</div>
