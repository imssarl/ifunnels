...
{elseif $msg!='success'}
<form action="" method="POST" class="wh validate" style="width:100%;">
	...
	<ol>
		...
		<li>
			<fieldset>
				...
				<label><input type="radio" name="arr[flg_status]" {if $arr.flg_status == 1}checked='1'{/if} value="1" class="status validate-one-required"> rejected</label>
			</fieldset>
		</li>
		<div id="cause" style="display:{if $arr.flg_status == 1}block{else}none{/if};">
		<li >
			<label>Cause <em>*</em></label><select name="arr[flg_cause]" class="required validate-custom-required emptyValue:'0'">
