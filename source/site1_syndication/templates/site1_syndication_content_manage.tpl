<br/>
{if $msg == 'delete'}
{include file='../../message.tpl' type='info' message='The Content was deleted successfully'}
{/if}
{if $msg == 'delete_error'}
{include file='../../message.tpl' type='error' message='Error: Can\'t delete content.'}
{/if}
{if $arrList}
<table>
<thead>
...
<tr  class="{if $k%2!='0'}alt-row{/if} sites">
