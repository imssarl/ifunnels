...
{if $v.name=='.'}
	...
	<td>&nbsp;</td>
{elseif $v.name=='..'}
	<td>{if $strCurrentDir!='/'}<a href="{url name='site1_hosting' action='browse' wg=$strPrevDir}" title="Click here to go back">{/if}<img src="/skin/i/frontends/design/buttons/folder.png" title="Click here to go back" /></a></td>
