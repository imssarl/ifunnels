<form class="wh validate" action="" style="width:50%;">
<fieldset>
	<legend></legend>
	<ol>
		<li>
...
<fieldset>
	...
	<ol>
		<li>
			<label>URL: <em>*</em> </label><input type="text" id="url" class="required"/>
			<p>Enter your site URL without http:// or www.<br />Example: yourwebsite.com</p>
		</li>
		<li>	
			<label>Title: <em>*</em> </label><input type="text"  id="title" class="required"/>
