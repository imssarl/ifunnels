...
<div id="main-content" class="card-box">
	...
	<fieldset>
		...
		<div class="form-group">
			...
			<input type="text" name="arrData[domain_text]" class="small-input text-input form-control" id="domain_text" value="{$arrData.domain_http}" style="width:200px;"><input type="button" class="button" id="check_domein" value="check">
		</div>
		<div class="form-group">
			<label>
