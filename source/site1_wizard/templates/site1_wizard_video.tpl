...
<div id="main-content">
	...
	<input type="hidden" name="arrData[type]" value="{Project_Wizard_Domain_Rules::R_VIDEO}"  />
	...
	<fieldset>
		...
		<div class="form-group">
			...
			<input type="text" name="arrData[domain_text]" id="domain_text" value="{$arrData.domain_http}" style="width:200px;"><input type="button" id="check_domein" value="check" class="button">
		</div>
		<div class="form-group">
			<label>
...
window.addEvent('domready', function(){
	...
	$('submit_button').addEvent('click',function(elt){
		if( validator.checker.validate() ){
			new Request({
				url: "{/literal}{url name='site1_wizard' action='video'}{literal}",
				onRequest: function(){
