					  			...
					  			<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;" width="100%">
									<tr>
						  				<td style="font-family: sans-serif; font-size: 14px; vertical-align: top;" valign="top">
											...
											<p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">Thank you for joining <b>{$membership}</b>.<br/><br/></p>
											{if ! empty( $password )}
											...
											{/if}
											{if ! empty( $membership_home_page_url )}<p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0;">Membership Home Page: {$membership_home_page_url}</p>{/if}
											<br/>
