...
<br/>
Your domain(s) is about to expire. Please make sure you have enough credits on your balance so the domains can be renewed automatically. Otherwise, THEY WILL EXPIRE.
<br/>
<br/>
<table style="border-collapse: collapse; border: 1px solid #999;" cellpadding="5" width="100%">
<tr>
	<th bgcolor="#CCC" align="center" width="25%"><b>Domain</b></th>
...
<tr>
	...
	<td align="center">{$i.expiry_domain|date_local:$config->date_time->dt_full_format}</td>
