	                  			...
	                  			<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;" width="100%">
	                    			<tr>
	                      				<td style="font-family: sans-serif; font-size: 14px; vertical-align: top;" valign="top">
	                      					<p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">Hello, {if !empty($nickname)}{$nickname}{else}User{/if}</p>
					                      	<p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
												To change your password go to this link: <a href="http://{Core_Module_Router::$domain}{url name='site1_accounts' action='change'}?code={$code_forgot}">http://{Core_Module_Router::$domain}{url name='site1_accounts' action='change'}?code={$code_forgot}</a>
											</p>
											<br/>
