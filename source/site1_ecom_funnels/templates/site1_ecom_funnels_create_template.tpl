...
<head>
	...
	<script>
		...
		var dataURLs = {
			siteData: '{/literal}{url name="site1_ecom_funnels" action="backend_siteData" w="id={$smarty.get.id}"}{literal}',
			pageDataUrl: '{/literal}{url name="site1_ecom_funnels" action="pageData"}{literal}',
			loadAll : '{/literal}{url name="site1_ecom_funnels" action="backend_loadAll"}{literal}',
			tsave : '{/literal}{url name="site1_ecom_funnels" action="backend_tsave"}{literal}',
			create: '{/literal}{url name="site1_ecom_funnels" action="create_template"}{literal}',
			getframe : '{/literal}{url name="site1_ecom_funnels" action="backend_getframe"}{literal}',
			cloneblock : '{/literal}{url name="site1_ecom_funnels" action="cloneoriginal_block"}{literal}',
			updateoriginal_block : '{/literal}{url name="site1_ecom_funnels" action="updateoriginal_block"}{literal}',
			deleteoriginal_block : '{/literal}{url name="site1_ecom_funnels" action="deleteoriginal_block"}{literal}',
			favoriteblock: '{/literal}{url name="site1_ecom_funnels" action="backend_favoriteblock"}{literal}',
			deleteblock: '{/literal}{url name="site1_ecom_funnels" action="backend_deleteblock"}{literal}',
			delimage: '{/literal}{url name="site1_ecom_funnels" action="backend_delimage"}{literal}',
			resizeImage: '{/literal}{url name="site1_ecom_funnels" action="backend_resizeImage"}{literal}',
		...
		var lockscreen = {
			requestUrl : '{/literal}{url name="site1_ecom_funnels" action="auth_back"}{literal}',
			authUrl : '{/literal}{url name="site1_ecom_funnels" action="auth_back" w="auth"}{literal}',
			isBackend: 'cadmin@cnm.info'
		};
	</script>
	{/literal}
...
<body class="builderUI">
	...
	<header class="clearfix">
		...
		<div class="btn-group" style="float: right;">
			...
			<ul class="dropdown-menu dropdown-menu-inverse dropdown-menu-right">
				...
				<li class="divider"></li>
				<li>
					<a href="{url name="site1_ecom_funnels" action="manage_template"}" id="backButton">
		...
		<select class="form-control select select-inverse select-block pull-right" id="selectCategory">
			<option value="0"{if $siteData.site.category_id==0} selected="selected"{/if}>In category</option>
			{foreach from=$arrCategory item=category}
			<option value="{$category.id}"{if $siteData.site.category_id==$category.id} selected="selected"{/if}>{$category.category_name}</option>
			{/foreach}
		</select>

		<a href="#" id="saveTemplate" data-toggle="modal" class="btn btn-primary pull-right actionButtons" data-siteid="0"><span class="fui-arrow-right"></span>Save page template</a>
	...
	<div id="builder">
		...
		<div class="builderLayout">
			...
			<div class="sideSecond" data-sidesecond="templates">
				...
				<div class="sideSecondInner">
					...
					<nav>
						<button><span>All templates</span><svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
							 x="0px" y="0px" viewBox="0 0 16 16" xml:space="preserve" width="16" height="16">
								<g class="nc-icon-wrapper" fill="#bdc3c7">
						...
						<ul class="">
							...
							<li class="templ" data-frames="8-9-10" data-heights="523-769-209" data-originalurls="/skin/pagebuilder/elements/Yummy/header2.html-/skin/pagebuilder/elements/Yummy/content10.html-/skin/pagebuilder/elements/Yummy/footer7.html"
							 data-name="index" data-pageid="1">
								<img src="/skin/pagebuilder/tmp/sitethumbs/templatethumb_1.jpg">
							</li>


							<li class="templ" data-frames="11" data-heights="192" data-originalurls="/skin/pagebuilder/elements/Yummy/header2.html-/skin/pagebuilder/elements/Yummy/content10.html-/skin/pagebuilder/elements/Yummy/footer7.html-/skin/pagebuilder/elements/Yummy/cta1.html"
							 data-name="index" data-pageid="5">
								<img src="/skin/pagebuilder/img/nothumb.png">
							</li>
						</ul>
					</nav>
				...
				<div class="styleEditorInner">
					...
					<div class="tab-content">
						...
						<div class="tab-pane formTab" id="form_Tab">
							...
							<input type="email" class="form-control margin-bottom-20" id="inputEmailFormTo" placeholder="Email address"
							 value="admin@admin.test" disabled>

							<textarea rows="6" class="form-control margin-bottom-20" id="textareaCustomMessage" placeholder="Custom confirmation message"
							 disabled></textarea>
							...
							<input type="text" class="form-control margin-bottom-20" id="inputCustomAction" placeholder="Action" value=""
							 disabled>
		...
		<div class="modal fade publishModal" id="publishModal" tabindex="-1" role="dialog" aria-hidden="TRUE">
			...
			<form action="sites/publish/1" target="_blank" id="publishForm" method="post" class="form-horizontal">
					...
					<div class="modal-content">
											...
											<tbody>
														...
														<td class="text-center" style="width: 30px;">
															<label class="checkbox no-label">
																<input type="checkbox" value="" id="" data-type="asset" name="assetFolders[]" data-toggle="checkbox">
															</label>
														</td>
														<td>
																														<span class="publishing">
																<span class="working"> <img src="img/publishLoader.gif"></span>
																<span class="done text-primary"> &nbsp;<span class="fui-check"></span></span>
															</span>
														</td>
													</tr>
																																				</tbody>
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-default btn-embossed" data-dismiss="modal" id="publishCancel">Cancel
								& Close</button>
							<button type="button" type="button" class="btn btn-primary btn-embossed disabled" id="publishSubmit">Publish
								Now</button>
						</div>
					</div><!-- /.modal-content -->
				</div><!-- /.modal-dialog -->
			...
			<div class="modal-dialog modal-hg">
				<div class="modal-content">
										...
										<div class="imageLibraryWrapper">
											<div class="images" id="myImages">
												<div class="slimWrapper">
													<div class="slim" id="slimWithSettings"
														data-meta-fresh="1"
														data-ratio="free"
															data-service="{url name="site1_ecom_funnels" action="imageUploadAjax"}"
															...
															data-status-file-type="Invalid file type, expects: $0"
															data-status-image-too-small="Image is too small, minimum size is: $0 pixels"
															data-status-unknown-response="An unknown error occurred"
															data-status-upload-success="Your image was uploaded"
															data-did-upload="slimImageUpload"
															data-button-edit-title="Edit"
															data-button-remove-title="Remove"
															data-button-upload-title="Upload"
															data-did-receive-server-error="slimHandleServerError"
															data-button-cancel-label="Cancel"
															data-button-confirm-label="Confirm"
															data-label="<b>+</b><strong>Add Image</strong><br>max size: 1MB">
											...
											<div class="imageDetailPanel" id="imageDetailPanel">
												...
												<div class="imageDimensionsWrapper">
													...
													<button class="btn btn-info btn-sm btn-block btn-embossed" id="buttonUpdateImageDimensions" data-loading="Working..." data-confirm="Image resized!">Update dimensions</button>
												</div>
										
												<div class="imageMoreActions">
													<div class="deleteImage">
														<a href="#" class="deleteImage" id="buttonDeleteImage">Delete image</a>
														<div class="confirm" id="confirmDeleteImage"><b>Are you sure?</b> <a href="" class="confirmYes" id="imageDeleteYes">Yes</a> / <a href="" class="confirmNo" id="imageDeleteNo">No</a></div>
													</div>
												</div>
									...
									<div class="images clearfix" id="adminImages">
										{if (isset($adminImages))}
											{foreach from=$adminImages item=img}
												<div class="image">
													<div class="imageWrap" 
														data-org-src="/skin/pagebuilder/images/{$img}" 
														data-admin="true" 
														data-thumb="/skin/pagebuilder/images/{$img}" 
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn btn-primary btn-embossed btn-wide" id="buttonImageModalUseImage">Use and Insert Image</button>
					</div>
				</div><!-- /.modal-content -->
			</div><!-- /.modal-dialog -->
	...
	<div class="modal fade newSiteModal" id="newSiteModal" tabindex="-1" role="dialog" aria-hidden="true" data-keyboard="false" data-backdrop="static">
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
						...
						<ul id="ulTemplateList" class="templateList" style="display: none;">
							...
							<li data-cat-id="{$template.category_id}" style="display: list-item;">
								<a href="" data-template-id="{$template.id}" class="">
									<img src="{Zend_Registry::get('config')->path->html->pagebuilder}{$template.sitethumb}">
								</a>
							</li>
							{/foreach}
						</ul>
				...
				<div class="modal-footer">
					<a href="{url name="site1_ecom_funnels" action="create_template"}?new" class="btn btn-primary btn-embossed" id="linkNewSite">
						...
						<div class="templateList" style="display: none;">
							...
							<div data-cat-id="{$template.category_id}" class="templateList__item">
								...
								<a href="" data-page-id="{$page.id}">
									<img src="{Zend_Registry::get('config')->path->html->pagebuilder}{$page.pagethumb}" alt="">
	...
	<div class="modal fade siteSettingsModal" id="siteSettings" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		...
		<div class="modal-dialog modal-lg">
			...
			<div class="modal-content">
				...
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
					<h4 class="modal-title" id="myModalLabel"><span class="fui-gear"></span> Template Settings</h4>
				</div>
				...
				<div class="modal-body">
					...
					<div class="modal-body-content">
						<form action="{url name="site1_ecom_funnels" action="backend_updateSettingsSite"}" id="siteSettingsForm" class="form-horizontal" method="post">
							...
							<div class="siteSettingsWrapper">
								<div class="optionPane">
									...
									<div class="form-group">
										<label for="sites_name" class="col-sm-3 control-label">Template name</label>
										<div class="col-sm-9">
											<input type="text" class="form-control" id="sites_name" name="sites_name" placeholder="Template name" value="{$siteData.sites_name}">
										</div>
									</div>
								</div>
							</div>
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default btn-embossed" data-dismiss="modal" id="cancelSiteSettingsButton"><span class="fui-cross"></span>
						<span>Cancel & Close</span></button>
					...
					<form class="form-horizontal" role="form" id="pageSettingsForm" action="{url name="site1_ecom_funnels" action="updatePageData"}">
						...
						<div class="optionPane">
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" class="form-control" id="pageData_title" name="arrData[pages_title]" placeholder="Page title" value="{if isset($pagesData.index)}{$pagesData.index.pages_title}{/if}">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<textarea class="form-control" id="pageData_headerIncludes" name="arrData[pages_header_includes]" rows="7" placeholder="Additional code you'd like to include in the <head> section">{if isset($pagesData.index)}{$pagesData.index.pages_header_includes}{/if}</textarea>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input name="arrData[google_fonts]" class="tagsinput" id="pageData_googleFonts" placeholder="Google fonts included on this page" value="">
								</div>
							</div>
						</div><!-- /.optionPane -->
					</form>
	...
	<div class="modal fade" id="previewModal" tabindex="-1" role="dialog" aria-hidden="TRUE">
		...
		<form action="{url name="site1_ecom_funnels" action="backend_livepreview"}" target="_blank" id="markupPreviewForm" method="post"
	...
	<div class="modal fade" id="delTemplateModal" tabindex="-1" role="dialog" aria-hidden="TRUE">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>
						Are you sure you want to permanently delete this page template? Deleting this template <b>will
							not affect</b> any existing sites. </p>
				</div><!-- /.modal-body -->

				<div class="modal-footer">
					<button type="button" class="btn btn-default btn-embossed" data-dismiss="modal"><span class="fui-cross"></span>
						Cancel & Close</button>
					<a href="sites/deltempl/1" class="btn btn-primary btn-embossed" id="templateDelButton"><span class="fui-check"></span>
						Yes, delete template</a>
				</div>
	...
	<template id="frameCoverTemplate">
		<div class="frameCover forAdmin">
			<div class="btn-group pull-right dropdownCloneInCat">
				<button class="btn btn-info btn-sm dropdown-toggle" type="button" data-toggle="dropdown">
					<span>Clone block in :</span> <span class="caret"></span>
				</button>
				<ul class="dropdown-menu" role="menu">
					{foreach from=$arrBlocksCategory item=category}
					<li><a href="#" data-cat-id="{$category.id}">{$category.category_name}</a></li>
					{/foreach}
				</ul>
			</div>
			<button class="btn btn-info btn-sm buttonDelOriginal" type="button" data-toggle="tooltip" title="Delete the original block."
			 data-saving="Deleting..." data-confirmation="Deleted!">
				<i class="fui-trash"></i>
			</button>
			<button class="btn btn-info btn-sm buttonSaveOriginal" type="button" data-toggle="tooltip" title="Save the current state of this block to the original."
			 data-saving="Saving..." data-confirmation="Saved!">
			...
			<button class="btn btn-inverse btn-sm favBlock" type="button" data-toggle="tooltip" title="Save this block as a template"
			 data-saving="Saving..." data-confirmation="Saved!">
				<i class="fa fa-star-o"></i>
			</button>
		...
		<div class="lockscreen__container">
			...
			<form method="post">
				<div class="input-group m-t-30">
					<input type="hidden" name="arrLogin[email]" value="cadmin@cnm.info" />
