...
{if $arrType.flg_multilng != 0}
<link href="/skin/_js/wh-language/language.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="/skin/_js/wh-language/language.js"></script>
{literal}
<script type="text/javascript">
	new Wh_Languages({
...
<thead>
	...
	<tr{if $k%2=='0'} class="matros"{/if}>
		...
		<td valign="top"><input type="text" class="elogin" name="arrCats[{$v.id}][remote_id]" value="{$v.remote_id}" /></td>
		{if $arrType.flg_sort}
		<td valign="top"><input type="text" class="elogin" name="arrCats[{$v.id}][priority]" value="{$v.priority}" /></td>
		{/if}
	</tr>
	...
	<tr>
		...
		<td valign="top"><input type="text" class="elogin" name="arrCats[0][title]" value="" /></td>
		<td valign="top"><input type="text" class="elogin" name="arrCats[0][remote_id]" value="" /></td>
		{if $arrType.flg_sort}
