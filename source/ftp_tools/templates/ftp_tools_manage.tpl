<div class="heading">
<a href="#" id="toggle" rel="block" class="menu" >New FTP details</a> | 
<a href="#" id="import-toggle" rel="block" class="menu" >Import FTP details</a>
</div>
...
<form class="wh validate" id="whForm" enctype="multipart/form-data" action="" method="POST" style="width:50%;">
<input type="hidden" name="arrFtp[id]" value="{$arrFtp.id}" />
	<fieldset>
		<legend>{if $arrFtp.id}Edit FTP details{else}Add new FTP{/if}</legend>
		<ol>
			<li>
				<label>Address <em>*</em></label><input class="required" title="Address" value="{$arrFtp.ftp_address|escape}" type="text" name="arrFtp[ftp_address]">
			</li>
			<li>
				<label>Username <em>*</em></label><input class="required" title="Address" value="{$arrFtp.ftp_username|escape}" type="text" name="arrFtp[ftp_username]">
			</li>
			<li>
				<label>Password <em>*</em></label><input class="required" title="Address" value="{$arrFtp.ftp_password|escape}" type="text" name="arrFtp[ftp_password]">
			</li>
			<li>
