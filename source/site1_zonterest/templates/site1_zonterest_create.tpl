{if !empty($arrNcsb.id)}
{include file="site1_zonterest_edit.tpl"}
{else}
{include file='../../error.tpl' fields=['ftp_directory'=>'Homepage Folder','domain_id'=>'Domain','template_id'=>'Template',
	...
	'main_keyword'=>'Title','flg_snippet'=>'Display type','arrArticleIds'=>'Articles list']}
...
<input type="hidden" name="arrNcsb[id]" value="{$arrNcsb.id}" />
	...
	<fieldset>
		...
		{else}
		<input type="hidden" value="699" name="arrNcsb[template_id]">
		{/if}
		<div>
			<div align="center">
	...
	<fieldset>
		...
		<div class="form-group">
			<label for="mainkeyword"><span>Title <em>*</em></span></label>
	...
	<fieldset>
		...
		<input type="hidden" name="arrNcsb[flg_snippet]" value="no" />
