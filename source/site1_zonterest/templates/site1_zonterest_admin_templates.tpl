...
<tr {if $k%2=='0'} class="matros"{/if}>
	...
	<td class="option">
		<a href="{url name='site1_zonterest' action='admin_templates'}?delete={$v.id}">del</a>
	</td>
</tr>
{/foreach}
</tbody>
