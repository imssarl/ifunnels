<div id="item_{$ASIN}">
	...
	<div class="amz_box">
		...
		<div class="amz_right_box">
			...
			<b>Unverb. Preisempf.:</b>&nbsp;<span class="amz_list_price">&nbsp;{$oldPrice}</span><br/>
	...
	<div class="amz_content_box">
		<span class="amz_details_header">Produktbeschreibungen</span><br/>
		<p>{$body}</p><br/>
		{if !empty($feature)}<span class="amz_details_header">Produktmerkmale</span><br/><p>{$feature}</p><br/>{/if}
		{if !empty({$relatedItems})}<br/><span class="amz_details_header">Verwandte Artikel</span><br/><p>{$relatedItems}</p>{/if}<br/>
		<center>
			<a target="_blank" href="{$link}" class="amz_more_info">
				<img src="images/more_info.png"/>
			</a>
