<div id="item_{$ASIN}">
	<div class="amz_box">
		...
		<div class="amz_right_box">
			<b>Classement:</b>&nbsp;<img src="{Zend_Registry::get( 'config' )->domain->url}{Zend_Registry::get( 'config' )->path->html->user_files}publishing/amazon/0/stars/{$stars}stars.png" /><br/>
			<div class="hide_list_price"><b>Prix conseillé:&nbsp;</b><span class="amz_list_price">&nbsp;{$oldPrice}</span><br/></div>
			<b>Prix:</b>&nbsp;<span class="amz_sale_price">{$smallPrice}</span><br/>
			<b>Disponibilité:</b>&nbsp;{$availability}<br/>
			<br/><br/>
	...
	<div class="amz_content_box">
		<div class="hide_description"><span class="amz_details_header">Descriptions du produit</span><br/><p class="check_body">{$body}</p><br/></div>
		<div class="hide_feature"><span class="amz_details_header">Détails sur le produit</span><br /><p class="check_feature">{$feature}</p><br /></div>
		<div class="hide_related_items"><br/><span class="amz_details_header">Articles connexes</span><br/><p class="check_related_items">{$relatedItems}</p><br/></div>
		<center>
			<a target="_blank" href="{$link}" class="amz_more_info">
				<img src="images/more_info.png"/>
			</a>
