...
<fieldset>
	...
	<p>
		<label>File:</label><textarea style="height:300px; width:100%;" class="text-input medium-input" id="editor"></textarea>
	</p>
	<p>
		<input type="button" value="Update file" id="save-file" class="button" {is_acs_write} > <input type="submit" value="Save Template" id="save-template" class="button" {is_acs_write} />
	</p>
