...
/**
 * Niche Video Site Builder module
 *
 * @category CNM Project
 * @package ProjectSource
 * @copyright Copyright (c) 2009-2012, web2innovation
...
class site1_nvsb extends Core_Module {
	...
	public function set_cfg() {
		$this->inst_script=array(
			...
			'actions'=>array(
				...
				array( 'action'=>'multiboxmanage', 'title'=>'Popup manage nvsb site', 'flg_tree'=>1, 'flg_tpl' => 1 ),
			),
		);
	}
	...
	public function content(){
		...
		$this->out['arrSite']=$_arr['arrNvsb'];
		
		$_placement=new Project_Placement();
		$_placement->withIds( $_arr['arrNvsb']['placement_id'] )->onlyOne()->getList( $this->out['arrSite']['domen'] );
