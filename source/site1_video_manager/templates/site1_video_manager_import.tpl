{if $msg}
	{foreach from=$msg item='m'}
		{if $m.r}
			{include file='../../message.tpl' type='error' message=$m.r}
		{else}
			{include file='../../message.tpl' type='info' message=$m.g}
		{/if}
	{/foreach}
{/if}
{include file="../../error.tpl"}
<form method="post" action="" class="wh validate" style="width:70%" enctype="multipart/form-data">
	...
	<fieldset>
		...
		<p>
			...
			<select name="source" class="required validate-custom-required emptyValue:'0' medium-input">
	...
	<p><input type="submit" value="Upload" class="button" {is_acs_write} /></p>
</form>
