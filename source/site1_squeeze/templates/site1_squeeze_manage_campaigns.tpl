...
<div class="heading">
	...
	<a class="menu" href="{url name='site1_squeeze' action='create_campaigns'}">Create Campaign</a> |
...
<table class="table  table-striped">
	...
	<tr id="row{$id}"{if $id%2=='0'} class="alt-row"{/if}>
			...
			<td align="center">{if $company.clicks > 0}<a title="View Details" style="cursor:pointer" rel="" href="{url name='site1_squeeze' action='summary'}?id={$company.id}&view=clicks" class="popup">{$company.clicks}</a>{else}0{/if}</td>
			<td align="center">{if $company.effectiveness > 0}<a title="View Details" style="cursor:pointer" rel="" href="{url name='site1_squeeze' action='summary' }?id={$company.id}&view=effectiveness" class="popup">{$company.effectiveness}</a>{else}0{/if}</td>
			<td>
				<a {is_acs_write} href="{url name='site1_squeeze' action='create'}?id={$company.id}">
					<img src="/skin/i/frontends/design/newUI/icons/pencil.png" border="0" title="Edit" style="cursor:pointer">
				</a>
				<a {is_acs_write} href="{url name='site1_squeeze' action='manage'}?company_del_id={$company.id}" class="alert" alt="Do you want delete this campaign?">
					<img src="/skin/i/frontends/design/newUI/icons/cross.png" border="0" title="Delete" style="cursor:pointer">
				</a>
				<a {is_acs_write} href="{url name='site1_squeeze' action='manage'}?company_duplicate_id={$company.id}" class="alert" alt="Do you want duplicate this campaign?">
					<img src="/skin/i/frontends/design/buttons/duplicate.png" border="0" title="Duplicate" style="cursor:pointer">
				</a>
				<a {is_acs_write} style="cursor:pointer" rel="" href="{url name='site1_squeeze' action='getcode'}?id={$company.id}&type=company" class="popup" title="View Part">
					<img src="/skin/i/frontends/design/buttons/view.gif" border="0" title="Get code">
				</a>
			</td>
	</tr>
	{foreachelse}
