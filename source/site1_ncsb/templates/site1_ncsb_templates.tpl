...
<table class="table  table-striped">
	...
	<tr>
		...
		<td align="center">
		{if $i.flg_belong==1}
		<a href="{url name='site1_ncsb' action='templates'}?delete={$i.id}" title="Delete"><i class="ion-trash-a" style="font-size: 20px; vertical-align: bottom; color: #AC1111; margin: 0 5px;"></i></a>
		<a href="{url name='site1_ncsb' action='edit_templates'}?id={$i.id}" title="Edit"><i class="ion-edit" style="font-size: 18px; vertical-align: bottom; color: #FFCC29; margin: 0 5px;"></i></a>
		{/if}
